...
local ChangeLogData = {
	"Changes:",
		"• updated KlixUI for ElvUI 1.2.7",		
		"• added more KlixUI Styles for Unitframes, Party-Raid Frames on Transparent Style",		
		"• Take account for the latest DataTexts update from ElvUI",			
		"• Added own custom DataTextsPanel via the new ElvUI option.",	
		"• Added KlixUI Chat Rightclick Menu",	
		"• Added 2 New Textures - credit Kringel",	
		"• Added Option for *Hide Player Brackets* in Chat - credit Merathilis",	
		"• Added Option for *Hide Community Chat* in Chat - credit Merathilis",	
		"• Added Option for *Emote Toggle* in Chat - credit Merathilis",
		"• Added Option for *Chat Fade* in Chat - credit Merathilis",			
		"• set Class Powerbar as default",		
		"• changed Addonname to KlixUI_Classic",
		"• Improvement of the KlixUI settings with fewer Tabs",		
		"• fixed missing Bar 6 after install",
		"• fixed issue with Classbar on Shamans",		
...
function KUI:CreateChangelog()
	...
	warning.text:SetText("|cffff0000WARNING: Delete your old ElvUI_KlixUI_Classic folder before installing v"..KUI.Version.."!!|r")
