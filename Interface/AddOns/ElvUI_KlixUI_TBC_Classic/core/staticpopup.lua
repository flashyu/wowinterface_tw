...
E.PopupDialogs["BUI_KUI_INCOMPATIBLE"] = {
	...
	OnCancel = function() T.DisableAddOn("ElvUI_KlixUI_TBC_Classic"); T.ReloadUI() end,
...
-- Compatibility
E.PopupDialogs["WINDTOOLS_DUI_INCOMPATIBLE"] = {
	...
	OnCancel = function() DisableAddOn("ElvUI_KlixUI_TBC_Classic"); ReloadUI() end,
...
E.PopupDialogs["LIVVEN_DUI_INCOMPATIBLE"] = {
