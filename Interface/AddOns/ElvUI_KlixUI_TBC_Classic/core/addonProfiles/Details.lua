		...
		["instances"] = {
			{
				...
				["row_info"] = {
					...
					["texture_background_class_color"] = false,
					["start_after_icon"] = false,
					["font_face_file"] = "Interface\\AddOns\\ElvUI_KlixUI_Classic\\media\\fonts\\Expressway.ttf",
					["textL_custom_text"] = "{data1}. {data3}{data2}",
					["font_size"] = 12,
					["texture_custom_file"] = "Interface\\",
					["texture_file"] = "Interface\\AddOns\\ElvUI_KlixUI_Classic\\media\\textures\\KlixOnePixel.tga",
					["icon_file"] = "Interface\\AddOns\\Details\\images\\classes_small_alpha",
					["use_spec_icons"] = true,
					["models"] = {
						["upper_model"] = "Spells\\AcidBreath_SuperGreen.M2",
					...
					["font_face"] = "Expressway",
					["texture_class_colors"] = true,
					["texture_background_file"] = "Interface\\Addons\\ElvUI_KlixUI_Classic\\media\\textures\\Empty.tga",
					["fast_ps_update"] = false,
					["textR_separator"] = ",",
					["height"] = 16,
				},
