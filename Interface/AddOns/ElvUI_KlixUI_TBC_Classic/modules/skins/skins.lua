...
local function StyleElvUIConfig()
	if T.InCombatLockdown() or not E.private.skins.ace3Enable then return end
...
local function Style_AceTabSelected(self, selected)
...
function KS:Initialize()
	...
	hooksecurefunc(S, 'Ace3_TabSetSelected', Style_AceTabSelected)
