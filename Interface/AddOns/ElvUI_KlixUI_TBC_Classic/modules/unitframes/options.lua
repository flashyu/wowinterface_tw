...
local texPath = [[Interface\AddOns\ElvUI_KlixUI_Classic\media\textures\roleIcons\]]
local texPathE = [[Interface\AddOns\ElvUI\media\textures\]]
local texPathR = [[Interface\RaidFrame\]]
local texPathB = [[Interface\AddOns\ElvUI_KlixUI_Classic\media\textures\readycheckIcons\]]
local texPathS = [[Interface\AddOns\ElvUI_KlixUI_Classic\media\textures\readycheckIcons\]]
			...
			general = {
				...
				args = {
					style = {
						order = 1,
						type = "toggle",
						name = L["|cfff960d9KlixUI|r Style"]..E.NewSign,
			...
			auras = {
				...
				args = {
					auraiconspacing = {
						order = 1,
						type = "group",
						name = KUI:cOption(L["Aura Icon Spacing"]),		
						guiInline = true,						
						args = {
							spacing = {
								type = 'range',
