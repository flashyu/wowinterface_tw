			...
			general = {
				...
				args = {
					...
					cursorFlash = {
						order = 26,
						type = "group",
						name = KUI:cOption(L["Cursor Flash"]),						
						guiInline = true,
					...
					alreadyknown = {
						order = 27,
						type = "group",
						name = KUI:cOption(L["Already Known"]),						
						guiInline = true,
			...
			panels = {
				...
				args = {
					...
					bottom = {
						...
						type = 'group',
						guiInline = true,
						name = KUI:cOption(L["Bottom Panel"]),	
			...
			popups = {
				...
				args = {
					...
					toggle = {
						order = 3,
						type = "group",
						name = KUI:cOption(L["Auto Answer"]),							
						guiInline = true,
