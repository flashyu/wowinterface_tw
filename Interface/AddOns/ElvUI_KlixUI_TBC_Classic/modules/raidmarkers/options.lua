...
local texPathAn = [[Interface\AddOns\ElvUI_KlixUI_Classic\media\textures\raidmarkers\anime\]]
local texPathAu = [[Interface\AddOns\ElvUI_KlixUI_Classic\media\textures\raidmarkers\aurora\]]
local texPathM = [[Interface\AddOns\ElvUI_KlixUI_Classic\media\textures\raidmarkers\myth\]]
