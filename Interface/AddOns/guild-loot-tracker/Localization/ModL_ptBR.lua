...
local L = LibStub("AceLocale-3.0"):NewLocale("GLT", "ptBR")

-- Options translation
--[[Translation missing --]]
L["|cffff00FFGLT:|r Guild Loot Tracker"] = "|cffff00FFGLT:|r Guild Loot Tracker"
--[[Translation missing --]]
L["|cffff00FFGLT:|r Guild Loot Tracker Options"] = "|cffff00FFGLT:|r Guild Loot Tracker Options"
--[[Translation missing --]]
L["About"] = "About"
--[[Translation missing --]]
L["About Guild Loot Tracker"] = "About Guild Loot Tracker"
--[[Translation missing --]]
...
--[[Translation missing --]]
L["Guild Loot Tracker was written to track loot over multiple raid groups by TimothyLuke."] = "Guild Loot Tracker was written to track loot over multiple raid groups by TimothyLuke."
--[[Translation missing --]]
...
--[[Translation missing --]]
L["Loot Threshold"] = "Loot Threshold"
--[[Translation missing --]]
L["Minimum item quality to log."] = "Minimum item quality to log."
--[[Translation missing --]]
...
--[[Translation missing --]]
L["The following people donate monthly via Patreon for the ongoing maintenance and development of Guild Loot Tracker.  Their support is greatly appreciated."] = "The following people donate monthly via Patreon for the ongoing maintenance and development of Guild Loot Tracker.  Their support is greatly appreciated."
--[[Translation missing --]]
