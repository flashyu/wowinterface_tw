...
local itemClassTable = {
	...
	{ "WOW_ITEM_CLASS_CONSUMABLE", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.PARENT },
	-- nil, CLASSIC, 0, 0 = consumable
	{ "WOW_ITEM_CLASS_CONSUMABLE_EXPLOSIVES_AND_DEVICES", ArkInventory.Const.ENUM.EXPANSION.SHADOWLANDS, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.EXPLOSIVES_AND_DEVICES },
	-- nil, CLASSIC, 0, 1 = chese bread (obsolete)
	{ "WOW_ITEM_CLASS_CONSUMABLE_POTION", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.POTION },
	-- nil, CLASSIC, 0, 2 = liquid (obsolete)
	{ "WOW_ITEM_CLASS_CONSUMABLE_ELIXIR", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.ELIXIR },
	{ "WOW_ITEM_CLASS_CONSUMABLE_FLASK", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.FLASK },
	{ "WOW_ITEM_CLASS_CONSUMABLE_SCROLL", ArkInventory.Const.ENUM.EXPANSION.WRATH, ArkInventory.Const.ENUM.EXPANSION.BFA, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.SCROLL },
	{ "WOW_ITEM_CLASS_CONSUMABLE_FOOD_AND_DRINK", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.FOOD_AND_DRINK },
	{ "WOW_ITEM_CLASS_CONSUMABLE_ITEM_ENHANCEMENT", ArkInventory.Const.ENUM.EXPANSION.WRATH, ArkInventory.Const.ENUM.EXPANSION.BFA, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.ITEM_ENHANCEMENT },
	{ "WOW_ITEM_CLASS_CONSUMABLE_BANDAGE", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.BANDAGE },
	{ "WOW_ITEM_CLASS_CONSUMABLE_OTHER", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.OTHER },
	{ "WOW_ITEM_CLASS_CONSUMABLE_VANTUSRUNE", ArkInventory.Const.ENUM.EXPANSION.BFA, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONSUMABLE.VANTUSRUNE },
	
	{ "WOW_ITEM_CLASS_CONTAINER", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT },
	{ "WOW_ITEM_CLASS_CONTAINER_BAG", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.BAG },
	{ "WOW_ITEM_CLASS_CONTAINER_SOULSHARD", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.SOULSHARD },
	{ "WOW_ITEM_CLASS_CONTAINER_HERBALISM", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.HERBALISM },
	{ "WOW_ITEM_CLASS_CONTAINER_ENCHANTING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.ENCHANTING },
	{ "WOW_ITEM_CLASS_CONTAINER_ENGINEERING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.ENGINEERING },
	{ "WOW_ITEM_CLASS_CONTAINER_JEWELCRAFTING", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.JEWELCRAFTING },
	{ "WOW_ITEM_CLASS_CONTAINER_MINING", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.MINING },
	{ "WOW_ITEM_CLASS_CONTAINER_LEATHERWORKING", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.LEATHERWORKING },
	{ "WOW_ITEM_CLASS_CONTAINER_INSCRIPTION", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.INSCRIPTION },
	{ "WOW_ITEM_CLASS_CONTAINER_FISHING", ArkInventory.Const.ENUM.EXPANSION.CATACLYSM, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.FISHING },
	{ "WOW_ITEM_CLASS_CONTAINER_COOKING", ArkInventory.Const.ENUM.EXPANSION.PANDARIA, nil, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.CONTAINER.COOKING },
	
	{ "WOW_ITEM_CLASS_WEAPON", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.WEAPON.PARENT },
	-- 01 = one-handed axes
	-- 02 = two-handed axes
	-- 03 = bows
	-- 04 = guns
	...
	{ "WOW_ITEM_CLASS_ARMOR", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.ARMOR.PARENT },
	-- 0 = miscellaneous
	{ "WOW_ITEM_CLASS_ARMOR_CLOTH", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.ARMOR.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.ARMOR.CLOTH },
	{ "WOW_ITEM_CLASS_ARMOR_LEATHER", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.ARMOR.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.ARMOR.LEATHER },
	-- 3 = mail
	-- 4 = plate
	-- 5 = bucklers
	-- 6 = shields
	...
	{ "WOW_ITEM_CLASS_PROJECTILE", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.PROJECTILE.PARENT },
	-- 0 = wand (obsolete)
	-- 1 = bolt (obsolete)
	{ "WOW_ITEM_CLASS_PROJECTILE_ARROW", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.PROJECTILE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.PROJECTILE.ARROW },
	{ "WOW_ITEM_CLASS_PROJECTILE_BULLET", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.PROJECTILE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.PROJECTILE.BULLET },
	-- 4 = thrown (obsolete)
	
	{ "WOW_ITEM_CLASS_TRADEGOODS", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT },
	-- 0 tradegoods
	{ "WOW_ITEM_CLASS_TRADEGOODS_PARTS", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARTS },
	{ "WOW_ITEM_CLASS_TRADEGOODS_EXPLOSIVES", nil, ArkInventory.Const.ENUM.EXPANSION.BFA, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.EXPLOSIVES },
	{ "WOW_ITEM_CLASS_TRADEGOODS_DEVICES", nil, ArkInventory.Const.ENUM.EXPANSION.BFA, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.DEVICES },
	
	{ "WOW_ITEM_CLASS_TRADEGOODS_JEWELCRAFTING", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.JEWELCRAFTING },
	{ "WOW_ITEM_CLASS_TRADEGOODS_CLOTH", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.CLOTH },
	{ "WOW_ITEM_CLASS_TRADEGOODS_LEATHER", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.LEATHER },
	{ "WOW_ITEM_CLASS_TRADEGOODS_METAL_AND_STONE", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.METAL_AND_STONE },
	{ "WOW_ITEM_CLASS_TRADEGOODS_COOKING", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.COOKING },
	{ "WOW_ITEM_CLASS_TRADEGOODS_HERBS", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.HERBS },
	{ "WOW_ITEM_CLASS_TRADEGOODS_ELEMENTAL", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.ELEMENTAL },
	{ "WOW_ITEM_CLASS_TRADEGOODS_OTHER", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.OTHER },
	{ "WOW_ITEM_CLASS_TRADEGOODS_ENCHANTING", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.ENCHANTING },
	{ "WOW_ITEM_CLASS_TRADEGOODS_INSCRIPTION", ArkInventory.Const.ENUM.EXPANSION.SHADOWLANDS, nil, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.TRADEGOODS.INSCRIPTION },
	
	-- 8 = generic (obsolete)
	-- 0 = generic (obsolete)
	
	{ "WOW_ITEM_CLASS_RECIPE", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT },
	-- 0 = book
	{ "WOW_ITEM_CLASS_RECIPE_LEATHERWORKING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.LEATHERWORKING },
	{ "WOW_ITEM_CLASS_RECIPE_TAILORING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.TAILORING },
	{ "WOW_ITEM_CLASS_RECIPE_ENGINEERING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.ENGINEERING },
	{ "WOW_ITEM_CLASS_RECIPE_BLACKSMITHING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.BLACKSMITHING },
	{ "WOW_ITEM_CLASS_RECIPE_COOKING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.COOKING },
	{ "WOW_ITEM_CLASS_RECIPE_ALCHEMY", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.ALCHEMY },
	{ "WOW_ITEM_CLASS_RECIPE_FIRST_AID", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.FIRST_AID },
	{ "WOW_ITEM_CLASS_RECIPE_ENCHANTING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.ENCHANTING },
	{ "WOW_ITEM_CLASS_RECIPE_FISHING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.FISHING },
	
	{ "WOW_ITEM_CLASS_RECIPE_JEWELCRAFTING", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.JEWELCRAFTING },
	{ "WOW_ITEM_CLASS_RECIPE_INSCRIPTION", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.INSCRIPTION },
	
	-- 10 = money
	-- 0 = money
	
	{ "WOW_ITEM_CLASS_QUIVER", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.QUIVER.PARENT },
	-- 0 quiver (obsolete)
	-- 1 quiver (obsolete)
	{ "WOW_ITEM_CLASS_QUIVER_ARROW", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.QUIVER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.QUIVER.ARROW },
	{ "WOW_ITEM_CLASS_QUIVER_BULLET", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.QUIVER.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.QUIVER.BULLET },
	
	{ "WOW_ITEM_CLASS_QUEST", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.QUEST.PARENT },
	-- 0 = quest
	
	{ "WOW_ITEM_CLASS_KEY", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.KEY.PARENT },
	-- 0 = key
	-- 1 = lockpick
	...
	{ "WOW_ITEM_CLASS_MISC", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.PARENT },
	{ "WOW_ITEM_CLASS_MISC_JUNK", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.JUNK },
	--
	{ "WOW_ITEM_CLASS_MISC_REAGENT", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.REAGENT },
	{ "WOW_ITEM_CLASS_MISC_PET", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.PET },
	{ "WOW_ITEM_CLASS_MISC_HOLIDAY", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.HOLIDAY },
	{ "WOW_ITEM_CLASS_MISC_OTHER", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.OTHER },
	{ "WOW_ITEM_CLASS_MISC_MOUNT", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.MOUNT },
	{ "WOW_ITEM_CLASS_MISC_MOUNT-EQUIPMENT", ArkInventory.Const.ENUM.EXPANSION.BFA, nil, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.MISC.MOUNT_EQUIPMENT },
	
	{ "WOW_ITEM_CLASS_GLYPH", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.GLYPH.PARENT },
	...
	{ "WOW_ITEM_CLASS_GEM", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.GEM.PARENT },
--	{ "WOW_ITEM_CLASS_GEM_ARTIFACTRELIC", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.GEM.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.GEM.ARTIFACTRELIC },
	
	{ "WOW_ITEM_CLASS_ITEM_ENHANCEMENT", ArkInventory.Const.ENUM.EXPANSION.SHADOWLANDS, nil, ArkInventory.Const.ENUM.ITEM.TYPE.ITEM_ENHANCEMENT.PARENT },
	
	{ "WOW_ITEM_CLASS_REAGENT", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.REAGENT.PARENT },
	
	{ "WOW_ITEM_CLASS_PET", ArkInventory.Const.ENUM.EXPANSION.SHADOWLANDS, nil, ArkInventory.Const.ENUM.ITEM.TYPE.BATTLEPET.PARENT },
	
	
	
	-- skills that dont have a hardcoded
	{ "WOW_SKILL_ALCHEMY", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.ALCHEMY },
	{ "WOW_SKILL_BLACKSMITHING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.BLACKSMITHING },
	{ "WOW_SKILL_ENCHANTING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.ENCHANTING },
	{ "WOW_SKILL_ENGINEERING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.ENGINEERING },
--	{ "WOW_SKILL_INSCRIPTION", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.INSCRIPTION },
	{ "WOW_SKILL_LEATHERWORKING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.LEATHERWORKING },
	{ "WOW_SKILL_TAILORING", nil, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.TAILORING },
	{ "WOW_SKILL_JEWELCRAFTING", ArkInventory.Const.ENUM.EXPANSION.WRATH, nil, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.PARENT, ArkInventory.Const.ENUM.ITEM.TYPE.RECIPE.JEWELCRAFTING },
