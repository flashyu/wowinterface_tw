...
GTFO = {
	...
	Version = "4.66.4"; -- Version number (text format)
	VersionNumber = 0; -- Numeric version number for checking out-of-date clients (placeholder until client is detected)
	RetailVersionNumber = 46604; -- Numeric version number for checking out-of-date clients (retail)
	ClassicVersionNumber = 46500; -- Numeric version number for checking out-of-date clients (Vanilla classic)
	BurningCrusadeVersionNumber = 46604; -- Numeric version number for checking out-of-date clients (TBC classic)
