...
step << Warrior/Warlock/Priest/Mage
    ...
    +|cFFFCDC00杀死|cFFFF5722年轻的清道夫|r和|cFFFF5 722黄昏鸟|r。在你拥有价值60铜的供应商物品（包括你的盔甲）之前，将它们洗劫一空|r << Mage
    +|cFFFCDC00杀死|cFFFF5722年轻的清道夫|r和|cFFFF5 722黄昏鸟|r。在你拥有价值50铜的供应商物品（包括你的盔甲）之前，将它们洗劫一空。|r << Priest
    +|cFFFCDC00杀死|cFFFF5722年轻的清道夫|r和|cFFFF5 722黄昏鸟|r。在你拥有10件价值铜的供应商物品（包括你的盔甲）之前，将它们洗劫一空。|r << Warrior/Warlock
    .mob Young Scavenger
    .mob Duskbat
    .money >0.01
...
step << Warlock/Mage
    ...
    .accept 1470 >>接任务: |cFFFCDC00控制小鬼|r << Warlock
...
step << Warlock
    #completewith next
    +|cFFFCDC00杀死|cFFFF5722无意识僵尸|r和|cFFFF5 722丧尸|r。在您拥有价值25铜的供应商物品（包括您的盔甲）之前，将其洗劫一空
    .mob Mindless Zombie
    .mob Wretched Zombie
    .money >0.0025
step << Warlock tbc
...
step
    ...
    >>杀死|cFFFF5722无意识僵尸|r和|cFFFF5722丧尸|r
...
step
    ...
    .xp 3+480>>研磨至480+/1400xp << Warrior/Rogue
    .xp 3+560>>研磨至560+/1400xp << !Warrior !Rogue
    .mob Mindless Zombie
    .mob Wretched Zombie
step
    #era
    .loop 40,Tirisfal Glades,31.72,63.98,30.69,63.88,30.90,62.20,30.73,61.66,31.14,61.41,31.80,61.83,32.85,32.38,63.02,32.90,63.54,33.41,63.06,33.75,62.86,33.51,63.82,33.55,64.57,33.29,64.96,31.72,63.98
    .xp 3+940>>研磨至940+/1400xp << Warrior/Rogue
...
step << Mage/Warlock/Priest
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Joshua|r
    >>|cFF0E8312从他那里购买|r |T132794:0|t[清爽的泉水]|cFF0E6312|r
    >>|cFFFCDC00不要低于1银|r << Mage/Warlock/Priest
    .vendor >>供应商垃圾箱
    .target Joshua Kien
    .money >0.1
    .isOnQuest 3901
...
step
    #hardcore
    #completewith next
    >>|cFFFCDC00跳下洞穴中的东西，然后按营地宏|r，执行跳跃式注销跳过
    .link https://www.youtube.com/watch?v=AOAlX9B5aO0 >>|cFFFCDC00单击此处获取指南|r
    .link /camp >>|cFFFCDC00单击此处获取宏|r
    >>|cFFFCDC00要创建宏，请键入/macro ingame。单击“新建”，为其命名，然后将粘贴“/camp”复制到框中。将新宏拖到动作栏|r上
...
step
    ...
    >>|cFFFCDC00尽可能避免|cFFFF5722猩红启动|r |T135843:0|t[霜甲]|cFFFCDC0（降低攻击速度）|r << Warrior/Rogue
...
step
    ...
    .goto Tirisfal Glades,31.35,66.21,10,0
    .goto Tirisfal Glades,30.86,66.05
    .accept 5651 >>接任务: |cFFFCDC00黑暗的恩赐|r << Priest
    .goto Tirisfal Glades,31.11,66.02 << Priest
    .target Novice Elreth
    .target Dark Cleric Duesten << Priest
step
...
>>与|cFF00FF25Deathguard Simmer|r交谈
...
>>与|cFF00FF25Innkeeper Renee|r交谈
...
step << Priest
    ...
    .trainer >>上楼训练你的课堂咒语
>>与|cFF00FF25Dark Cleric Beryl|r交谈
...
>>与|cFF00FF25Coleman Farthing|r交谈
...
>>与|cFF00FF25Gretchen Dedmar|r交谈
...
>>与|cFF00FF25Yvette Farthing|r交谈
...
>>与|cFF00FF25Carendin Halgar交谈|r
...
>>与|cFF00FF25Anastasia Hartwell交谈|r
...
>>与|cFF00FF25Deathguard Linnea|r交谈
...
>>与|cFF00FF25Gunther Arcanus|r交谈
...
>>与|cFF00FF25Dalar Dawnweaver交谈|r
...
.target High Executor Hadrec
    .accept 440 >>接任务: |cFFFCDC00黛丽娅的戒指|r << Undead
...
>>与|cFF00FF25Michael Garrett|r交谈
