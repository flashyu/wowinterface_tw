...
.target Priestess Josetta
>>与|cFF00FF25Josetta|r牧师交谈
    .accept 5635 >>接任务: |cFFFCDC00绝望祷言|r << tbc
    .trainer >>训练你的职业技能
step << Mage
    .goto Elwynn Forest,43.2,66.2
    .trainer >>训练你的职业技能
...
>>与|cFF00FF25Ma Stonefield|r交谈
    ...
    .turnin 88 >>交任务: |cFF00FF25公主必须死！|r << !Warrior !Paladin
...
.target Osric Strang
    .accept 6261 >>接任务: |cFFFCDC00杜加尔·朗德瑞克|r << Warlock
step << Warlock
    #completewith next
...
step << Warlock
    #label HearthIF
    .zone Ironforge >>前往: |cFFDB2EEF铁炉堡|r << tbc
    .hs >>从火炉到暴风 << wotlk
step << !Warlock wotlk
        .hs >>从火炉到暴风
step << Warlock wotlk
