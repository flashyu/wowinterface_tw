...
step
    #sticky
    #label xp3
    .xp 3+1110 >>在回来的路上磨合到1110+/1400经验
step
...
step << !Priest !Mage
    .xp 5+1715 >> 在返回1715+/2800xp的途中进行研磨
    .goto Elwynn Forest,48.2,42.9
--N SoM xp values
step << Priest/Mage
...
step
    ...
    .collect 3172,3 --Collect Boar In测验ines (x3)
step
...
step
    ...
    #completewith Thelsamar1
    >>在赛尔萨马尔血肠区杀死野猪
    .complete 418,1 --Collect Boar In测验ines (x3)
step
    #label Thelsamar1
...
step
    ...
    .abandon 3904 >> 放弃米莉的收获
step
    .xp 5+1220 >> 在返回1220+/2800xp的途中进行研磨
    .goto Elwynn Forest,48.2,42.9
step
    .goto Elwynn Forest,48.2,42.9
    .turnin 6 >> 在Garrick脚垫上交赏金
...
step
    .goto Loch Modan,38.66,18.72
    .xp 13+5850 >> 将Kobolds升级到5850+/11400xp
step
