...
step << Warlock
    ...
    >>在途中杀死一些狼，|cFFFCDC00然后观看视频|cFFFCDC00不要跳断腿|r抢书后使用炉石。
...
step
    ...
    .accept 3100 >>接任务: |cFFFCDC00简要的信件|r << Warrior
    .accept 3101 >>接任务: |cFFFCDC00圣洁信件|r << Paladin
    .accept 3102 >>接任务: |cFFFCDC00密文信件|r << Rogue
    .accept 3103 >>接任务: |cFFFCDC00神圣信件|r << Priest
    .accept 3104 >>接任务: |cFFFCDC00雕文信件|r << Mage
    .accept 3105 >>接任务: |cFFFCDC00被污染的信件|r << Warlock
step
    .xp 3 >>升级到3
step
...
step
    #sticky
    #label xp3
    .xp 3+1110>>在回来的路上提升经验到1110+/1400xp
step
    #completewith next
    >>与|cFF00FF25Godric Rothgar|r。
    .target Godric Rothgar
...
step
    ...
    .accept 59 >>接任务: |cFFFCDC00布甲和皮甲|r << Warlock
step
...
step
    ...
    .accept 11 >>接任务: |cFFFCDC00悬赏河爪豺狼人|r << Warlock
step << Warrior
    .money >0.3174
    #som
...
>>与|cFF00FF25Thor|r交谈
    .turnin 6181 >>交任务: |cFF00FF25快递消息|r << Human
.target Thor
    .accept 6281 >>接任务: |cFFFCDC00赶赴暴风城|r << Human
step
    .goto Westfall,56.6,52.6
    .fly Stormwind >>飞到暴风城
step << Rogue
...
>>与|cFF00FF25Dungar Longdrink|r交谈
...
step
    .goto Elwynn Forest,29.840,85.997
>>与|cFF00FF25Tommy Joe Stonefield交谈|r
    .turnin 106 >>交任务: |cFF00FF25年轻的恋人|r
.target Tommy Joe Stonefield
    .accept 111 >>接任务: |cFFFCDC00托米的祖母|r
step
...
step
    .goto Elwynn Forest,34.9,83.9
>>与|cFF00FF25Gramma Stonefield|r交谈
    .turnin 111 >>交任务: |cFF00FF25托米的祖母|r
.target Gramma Stonefield
    .accept 107 >>接任务: |cFFFCDC00给威廉·匹斯特的信|r
step
...
>>与|cFF00FF25副Rainer|r交谈
    .turnin 239 >>交任务: |cFF00FF25西泉要塞|r
.target Deputy Rainer
    .accept 11 >>接任务: |cFFFCDC00悬赏河爪豺狼人|r << Warlock/Warrior
step << Warrior
