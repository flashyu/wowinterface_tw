...
step
    #requires Shank
    .openmap Durotar
    .技巧 skinning,75 >> 在Durotar中，通过杀死野兽、掠夺野兽，然后剥皮，从1-75开始升级你的剥皮。按“M”打开地图以查看路线。
...
step
    ...
    .技巧 skinning,125 >> 在荒野从75-125整平你的皮肤
...
step
    ...
    .技巧 skinning,165,1
step
    .技巧 skinning,165 >> 在荒地从125-165整平你的皮肤
...
step
    ...
    .技巧 skinning,205,1
step
    .技巧 skinning,205 >> 在千针165-205之间平整您的皮肤
...
step
    ...
    .技巧 skinning,230,1
step
    .技巧 skinning,230 >> 在费拉拉斯从205-230开始平整您的皮肤
...
step
    ...
    .技巧 skinning,260 >> 在费拉拉斯，从230-260开始平整你的皮肤
...
step
    ...
    .技巧 skinning,280 >> 在费拉拉斯，从260-280开始平整您的皮肤
...
step
    ...
    .技巧 skinning,300,1
step
    .技巧 skinning,300 >> 在Un'Goro陨石坑从280-300整平您的皮肤
    .loop 45,安戈洛环形山,31.5,28.9,37.1,28.9,42.1,33.4,42.7,40.2,40.7,45.1,34.3,44.6,29.4,40.0,29.4,34.4,31.5,28.9
step << Mage
    #completewith next
...
step
    #completewith next
    .goto 地狱火半岛,56.3,38.6
    .zone 地狱火半岛 >> 乘坐飞行坐骑飞往地狱火半岛的萨尔玛
    .技巧 skinning,305,1
    .技巧 riding,<300,1
step
    #label Moorutu
...
step
    ...
    .技巧 skinning,305 >> 在Hellfire半岛从300-305开始平整您的皮肤
    .loop 45,地狱火半岛,61.6,57.2,63.3,61.3,65.3,61.8,68.9,62.0,70.1,64.5,68.1,66.2,65.1,66.6,63.8,69.4,63.6,73.1,63.4,77.2,60.9,77.7,59.0,74.1,56.6,71.8
step
    >>杀死无爪黑豹，然后剥下它们的皮
    .技巧 skinning,310 >> 在Hellfire半岛从305-310开始平整您的皮肤
    .loop 45,地狱火半岛, 47.7,77.9,47.5,73.2,48.6,69.8,49.3,66.7,51.0,66.1,52.4,69.7,53.2,74.0,51.6,78.0,49.6,79.5,47.7,77.9
step
    >>杀死野猪孵化器和野猪掠夺者，然后剥下他们的皮
    .技巧 skinning,330 >> 在Hellfire半岛从310-330整平您的皮肤
    .loop 45,地狱火半岛,41.1,82.5,35.2,87.4,34.7,91.1,37.2,91.8,40.3,88.5,42.4,85.3,41.1,82.5
step << Mage
    #completewith next
    .zone Shattrath City >> 传送到沙塔斯市
    .技巧 skinning,375,1
...
step
    #completewith next
    .goto 纳格兰,77.4,54.6
    .zone 纳格兰 >> 乘坐飞行坐骑飞往纳格朗
    .技巧 skinning,375,1
step
    >>杀死塔布克和克莱夫蹄，然后剥下它们的皮
    .技巧 skinning,375 >> 在纳格兰从330-375开始平整您的皮肤
    .loop 45,纳格兰,51.3,37.6,52.3,33.6,54.1,30.0,52.8,26.1,50.6,25.3,48.4,26.8,46.6,27.2,46.6,33.6,46.5,40.3,47.0,45.1,49.2,49.2,53.5,53.8,55.3,52.8,57.3,49.8,60.1,48.4,62.0,46.1,60.6,43.4,57.9,42.5,54.7,42.5,52.7,40.7,51.3,37.6
step
    +恭喜您达到375 剥皮！
]])
...
step
    ...
    .技巧 skinning,75 >> 在Elwynn，通过杀死野猪，掠夺野猪，然后剥皮，从1-75开始升级你的剥皮等级。按“M”打开地图以查看路线。
...
step
    ...
    .zoneskip Loch Modan
step
    .技巧 skinning,115 >> 在莫丹湖从75-115开始平整您的皮肤
...
step
    .技巧 skinning,125 >> 在莫丹湖从115-125开始平整您的皮肤
...
step
    ...
    .zoneskip Wetlands
step
    .技巧 skinning,155 >> 在湿地中从140-155整平您的皮肤
...
step
    .技巧 skinning,185 >> 从155-185年开始在阿拉希高地平整你的皮肤
...
step
    .技巧 skinning,205 >> 从185-205年开始，在阿拉希高地平整您的皮肤
...
step
    #completewith next
    .goto 地狱火半岛,56.7,63.8
    .zone 地狱火半岛 >> 飞向荣誉在地狱火半岛的飞行坐骑上举行
    .技巧 skinning,330,1
    .技巧 riding,<300,1
step
    #label Jelena
    .goto 地狱火半岛,54.9,63.6,12,0
    .goto 地狱火半岛,54.5,63.2
