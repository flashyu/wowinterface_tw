...
.zone BoreanTundra >>前往暴风港。船到了就上船。带它去Borean苔原
step << Alliance
#completewith end
#label VKFP
...
step
#completewith next
.goto 龙枯草,12.39,55.22
.zone 龙枯草 >> 前往龙枯草
step << Horde
#completewith end
#label AgmarFP
.goto 龙枯草,37.51,45.77
>>前往阿格玛锤子
...
#requires WyrmFP
#label VenomFP
.goto 龙枯草,76.48,62.20
.fp Venomspite >> 获取Venomwhile飞行路径
step << Horde
#completewith end
#requires VenomFP
#label VenomHS
.goto 龙枯草,76.87,63.13
.home >>将你的心设为毒液怨恨
step << Alliance
#completewith end
#label StarsFP
.goto 龙枯草,29.15,55.32
>>星空之旅
.fp Stars' Rest >> 获取星星的休息飞行路径
step << Alliance
.goto 龙枯草,28.84,56.16
>>与兰森交谈
.turnin 12157 >>交出丢失的信使
.accept 12171 >>接受叛徒和叛国罪
step << Alliance
.goto 龙枯草,29.16,55.37
>>与Palena交谈
>>接受这个任务会让你飞到温特加德要塞
...
#completewith end
#label WinterHS
.goto 龙枯草,77.46,51.43
.home >>将您的炉石设置为Wintergarde Keep
step << Alliance
#requires WinterHS
.goto 龙枯草,77.18,50.09
...
step << skip
#requires VenomHS
.loop 50,龙枯草,87.90,41.21,87.00,42.19,86.45,40.12,85.51,41.24,83.78,41.98,84.14,40.72,84.49,37.06,87.64,35.43,87.90,41.21
.xp 73 >> AoE将猩红打磨到73
step << skip
#level 73
#completewith next
...
step
.isQuestTurnedIn 10804
.goto 暗月峡谷,61.8,60.0,80,0
.goto 暗月峡谷,66.2,60.4,80,0
.goto 暗月峡谷,61.8,60.0
...
step
.isQuestTurnedIn 10804
.goto 暗月峡谷,66.0,80.0,60,0
.goto 暗月峡谷,66.3,82.3,30,0
.goto 暗月峡谷,67.3,81.7,30,0
.goto 暗月峡谷,68.3,79.8,30,0
.goto 暗月峡谷,71.7,83.1,30,0
.goto 暗月峡谷,76.7,83.3,60,0
.goto 暗月峡谷,66.0,80.0
...
step
.goto 暗月峡谷,53.0,62.4,60,0
.goto 暗月峡谷,52.7,68.6,60,0
.goto 暗月峡谷,51.6,63.8,60,0
.goto 暗月峡谷,52.3,59.1,60,0
.goto 暗月峡谷,53.0,62.4
...
step
.goto 纳格兰,73.6,59.2,40,0
.goto 纳格兰,69.8,52.8,40,0
.goto 纳格兰,72.8,44.6,40,0
.goto 纳格兰,65.8,38.2,0
>> 杀死并掠夺该地区的闪电元素，尘啸者拥有最好的下降率。
.collect 24504,1,9861,1
step << Alliance
.goto 纳格兰,48.6,34.4,40,0
.goto 纳格兰,43.0,31.6,40,0
.goto 纳格兰,41.0,27.0,40,0
.goto 纳格兰,35.8,26.0,40,0
.goto 纳格兰,34.0,20.4,0
...
step
.collect 32464,40
.技巧 mining,<350,1 >> 如果你有两种采集职业，那么你每天只能提交一次荷兰之翼采集，请跳过下一步购买
step
.collect 32468,40
.技巧 herbalism,<350,1 >> 如果你有两种采集职业，那么你每天只能提交一次荷兰之翼采集，请跳过下一步购买
step
.collect 32470,35
.技巧 skinning,<350,1
step
...
.goto 泰罗卡森林,39.8,72.2
.accept 10178 >> 接受查找间谍To'gun
step << Horde
.requires quest,11506
.goto 泰罗卡森林,49.8,46.6
.accept 11506 >> 接受Auchindoun的精神
step << Horde
.requires quest,11506
.goto 泰罗卡森林,32.4,57.8,40,0
.goto 泰罗卡森林,42.5,53.9,40,0
.goto 泰罗卡森林,48.9,60.5,40,0
.goto 泰罗卡森林,47.3,72.3,40,0
.goto 泰罗卡森林,40.5,78.1,40,0
.complete 11506,1
step << Alliance
.requires quest,11505
.goto 泰罗卡森林,55.8,53.8
...
.goto 泰罗卡森林,35.0,65.2
.accept 10164 >> 接受一切都会好起来的
step
.requires quest,10667
.goto 泰罗卡森林,77.6,38.6
...
step << Alliance
.requires quest,9492
.goto 地狱火半岛,56.6,66.6
.accept 9492 >> 接受扭转局面
step << Horde
.requires quest,9495
.goto 地狱火半岛,55.0,36.0
.accept 9495 >> 接受巫师的意志
step << Alliance
.requires quest,9494
.goto 地狱火半岛,53.8,65.6
.accept 9494,1 >> 接受Fel Embers
step << Alliance
.requires quest,9493
.goto 地狱火半岛,56.8,62.6
.accept 9493 >> 接受恶魔部落的骄傲
step << Horde
.requires quest,9496
.goto 地狱火半岛,55.0,36.2
...
step
.requires quest,10257
.goto 荷兰风暴,58.6,89.2,-1
.goto 荷兰风暴,57.6,89.6,-1
.goto 荷兰风暴,58.8,88.0,-1
>> 从一个房间的房子里收集简编章节。
...
step << Horde
.requires quest,9937
.goto 纳格兰,38.2,77.2,60,0
.goto 纳格兰,47.0,70.0,60,0
.goto 纳格兰,37.0,58.2,60,0
.goto 纳格兰,31.0,69.2,60,0
...
step
.requires quest,9853
.goto 纳格兰,29.0,67.4,40,0
.goto 纳格兰,32.0,80.6,40,0
.goto 纳格兰,41.0,82.6,40,0
...
.goto 泰罗卡森林,61.2,74.2,20,0
.goto 泰罗卡森林,69.8,75.0,20,0
.goto 泰罗卡森林,74.6,88.4,20,0
...
step
.requires quest,11020
.goto 暗月峡谷,45.8,61.5,20
>> 杀死附近的Felfire Diemetradon获取Fel腺体。
.collect 32502,12,11020,1
step
.requires quest,11020
.goto 暗月峡谷,66.0,82.1,30,0
.goto 暗月峡谷,76.3,85.4,30,0
...
.goto 泰罗卡森林,64.6,66.6
.accept 11008 >> 接受草图上的火焰
step
.requires quest,11008
.goto 泰罗卡森林,70.4,80.1,10,0
.goto 泰罗卡森林,74.7,88.3,10,0
.goto 泰罗卡森林,67.6,86.0,10,0
.goto 泰罗卡森林,62.6,80.8,10,0
...
step << Horde
.goto 地狱火半岛,87.4,48.2
.accept 10289 >> 接受萨尔玛之旅
step << Horde
#completewith next
.goto 地狱火半岛,55.8,36.8
...
.turnin 9400 >> 交出刺客
step << Alliance
.goto 地狱火半岛,87.4,50.7
.accept 10288 >> 接受到达外域
step << Alliance
.goto 地狱火半岛,87.4,52.4
.turnin 10288 >> 到达外域时的交车
.accept 10140 >> 接受荣誉之旅
step << Alliance
.goto 地狱火半岛,54.7,62.8
...
.accept 10141 >> 接受军团重生
step << Alliance
.goto 地狱火半岛,61.7,60.7
.turnin 10141 >> 交出军团重生
.accept 10142 >> 接受痛苦之路
step << Alliance
.goto 地狱火半岛,67.0,58.6
>> 消灭该地区的恶魔
.complete 10142,1 
.complete 10142,2 
.complete 10142,3 
...
.accept 10143 >> 接受催交点
step << Alliance
.goto 地狱火半岛,56.6,66.5
.accept 10047 >> 在禁区内接受来自Warp Scryer Kryv的荣耀之路。
step << Alliance
.goto 地狱火半岛,64.5,49.6,10,0
.goto 地狱火半岛,54.6,50.4,10,0
.use 25889
...
.turnin 10047 >> 转向荣耀之路
step << Alliance
.goto 地狱火半岛,23.0,40.4
>> 前往Hellfire半岛西部
.accept 9390 >> 接受搜索Sedai。
step << Alliance
.goto 地狱火半岛,26.8,37.6
.turnin 9390 >> 交出寻找塞岱。
step << Alliance
...
.accept 9774 >> 接受厚水螅鳞片
step << Horde
.goto 赞加沼泽,84.1,39.0,80,0
.goto 赞加沼泽,85.2,54.6,80,0
.goto 赞加沼泽,80.1,34.3,80,0
.goto 赞加沼泽,81.0,41.3
>> 杀死该地区的九头蛇并掠夺其鳞片。
...
step
#label thickysticky
.goto 泰罗卡森林,44.4,26.2 
.accept 9968 >> 接受奇异能量。
.accept 9971 >> 接受灌木丛中的线索。
step
#sticky
#requires thickysticky
.goto 泰罗卡森林,45.1,21.8,40,0
.goto 泰罗卡森林,44.4,30.8,40,0
.goto 泰罗卡森林,45.1,21.8
...
step
.goto 泰罗卡森林,38.3,26.6,80,0
.goto 泰罗卡森林,50.3,29.0,80,0
.goto 泰罗卡森林,38.3,26.6
.line 泰罗卡森林,38.3,26.6,40.6,25.5,47.2,27.0,50.3,29.0
.skipgossip
...
step << Horde
.goto 泰罗卡森林,48.8,45.6
.accept 10000 >> 接受不受欢迎的状态
step << Horde
.goto 泰罗卡森林,67.4,51.8
>> 杀死该地区的翘皮狮子
.complete 10000,1 
step << Horde
.goto 泰罗卡森林,63.4,42.6
.turnin 10000 >> 提交不受欢迎的状态
step << Alliance
.goto 泰罗卡森林,58.2,54.8
...
#sticky
#completewith endofseedoil
.goto 泰罗卡森林,73.6,36.0
>> 飞到塔顶
step << Alliance
.goto 泰罗卡森林,73.8,35.8
>> 杀掉莎斯·沃尔登以获得最终密码。
...
.turnin 10447 >> 提交最终代码。
step << Alliance
.goto 泰罗卡森林,57.0,53.5
.turnin 10446 >> 提交最终代码。
step << Horde
#requires seedoil
.goto 泰罗卡森林,50.1,44.9
.turnin 9993 >> 加入Olemba籽油。
step
#label endofseedoil
.goto 泰罗卡森林,49.8,76.2
.accept 10920 >> 接受堕落者。
step
.goto 泰罗卡森林,51.8,78.8,30,0
.goto 泰罗卡森林,55.6,61.2
>> 沿着骨废料的边缘杀死恐惧方寡妇。
.complete 10920,1
step
.goto 泰罗卡森林,49.8,76.2
...
step << Horde
.goto 泰罗卡森林,19.8,60.8
.turnin 9888 >> 交出无能的领导人。
.accept 9889 >> 接受不要杀死胖人。
step << Horde
.goto 泰罗卡森林,19.8,62.6
>> 杀死10名巨石拳入侵者。不要和无情的乌克尔战斗。
.complete 9889,1
step << Horde
.goto 泰罗卡森林,20.0,63.4
>> 殴打Unkor直到他提交。
.complete 9889,2
.turnin 9889 >> 上车不要杀胖人。
.accept 9890 >> 接受成功！
step << Horde
.goto 泰罗卡森林,19.6,60.8
.turnin 9890 >> 成功交出！
...
.accept 9922 >> 接受纳格兰的双胞胎裂缝。
step << Alliance
.goto 纳格兰,50.2,56.8,40,0
.goto 纳格兰,40.8,31.6,40,0
>> 杀死营地周围的巨石拳食人魔
.complete 9922,1
.complete 9922,2
step << Alliance
...
.accept 10572 >> 接受设置炸弹
step << Alliance
.goto 暗月峡谷,26.2,41.1,40,-1
.goto 暗月峡谷,22.2,35.4,40,-1
...
.complete 10624,1 
step << Horde
.goto 暗月峡谷,32.0,32.0,80,0
.goto 暗月峡谷,30.7,36.2,60,0
.goto 暗月峡谷,32.0,32.0
>> 杀死无间道攻击者
.complete 10595,1 
step << Horde
.goto 暗月峡谷,32.2,38.1,60,0
>> 完成对不断燃烧的灰堆的掠夺
.complete 10624,1 
step << Horde
.goto 暗月峡谷,37.4,30.4
...
.accept 10597 >> 设置炸弹
step << Horde
.goto 暗月峡谷,26.2,41.1,20,-1
.goto 暗月峡谷,22.2,35.4,20,-1
...
step
#scryer
.goto 荷兰风暴,25.4,71.8,100,0
.goto 荷兰风暴,22.0,72.7,40,0
.goto 荷兰风暴,25.4,71.8
>> 杀死该区域的Sunfrew敌人。
.complete 10193,1
.complete 10193,2
...
.complete 10418,1
step
.goto 荷兰风暴,44.0,49.4,20,0
.goto 荷兰风暴,44.8,57.2,20,0
.goto 荷兰风暴,44.0,49.4
...
#group RestedXP WLK的准备
#name 启动移交指南
#next RestedXP联盟70-80\70.5-71.5 Borean苔原抢夺开始 << Alliance
#next RestedXP部落70-80\70.5-71.5 Borean苔原抢夺开始 << Horde
step
#sticky
#completewith start1
...
>> 与血精灵对话
.goto 泰罗卡森林,48.8,44.6
.accept 10039 >> 接受与Neftis探子交谈
step << Horde
.isOnQuest 10039
.goto 泰罗卡森林,39.0,43.8
.turnin 10039 >> 转而与侦察员Neftis交谈
step << Alliance
.isOnQuest 10038
.goto 泰罗卡森林,40.4,36.0
.turnin 10038 >> 与私人周交谈
step
.itemcount 31707,1
.goto 泰罗卡森林,37.4,51.2
.use 31707,1 >> 使用包中的阴谋命令接受任务
.accept 10880 >> 接受阴谋集团订单
.turnin 10880 >> 交出阴谋命令
step
.isOnQuest 10218
.goto 泰罗卡森林,39.4,58.4
...
step << Alliance
.isQuestAvailable 10847
.goto 泰罗卡森林,57.6,56.0
.accept 10863 >> 接受阿拉科亚的秘密。
step
.itemcount 32523,1
.goto 泰罗卡森林,64.0,66.8
...
step << Horde
.isOnQuest 9405
.goto 地狱火半岛,54.2,37.8
.turnin 9405 >> 交出酋长的授权书。
step << Horde
.isOnQuest 10756
.goto 地狱火半岛,53.2,38.2
