...
step
    ...
    .技巧 herbalism,70 >> 在蒂里斯法尔·格拉德斯(Tirisfal Glades)，从1-70开始提升你的草药水平。按“M”打开地图以查看路线。
...
step
    .技巧 herbalism,115 >> 在银松森林从70-115升级你的草药
...
step
    ...
    .技巧 herbalism,150,1
step
    .技巧 herbalism,150 >> 在希尔斯布莱德丘陵，从115-150年开始提升你的草药水平
...
step
    ...
    .技巧 herbalism,170 >> 在悲伤沼泽中从150-170点升级草药
...
step
    ...
    .技巧 herbalism,225 >> 在悲伤沼泽中从170-225升级你的草药
...
step << !Mage
    ...
    .goto 地狱火半岛,88.9,50.2
    .zone 地狱火半岛 >>进入爆炸之地。穿过黑暗之门
    .技巧 herbalism,300,1
    .cooldown item,6948,<0,1
step << !Mage
    #completewith next
...
step << !Mage
    ...
    .zoneskip Swamp of Sorrows
step
    .技巧 herbalism,300 >> 在悲伤沼泽中从225-300点升级草药
...
step
    #label 荷兰风暴
    .技巧 herbalism,375 >> 在暴风雨中从350-375升级你的草药
    .loop 60,荷兰风暴,21.8,76.1,20.6,67.5,26.8,62.6,27.1,53.5,34.0,53.6,30.6,43.1,23.8,42.3,24.7,34.9,36.8,39.0,38.5,40.6,40.0,35.9,42.9,38.8,46.4,38.9,48.4,36.1,44.6,27.4,35.6,25.3,29.2,17.4,29.2,14.6,31.1,13.5,36.4,18.2,39.1,17.8,41.3,21.2,42.8,18.1,45.4,18.3,46.4,9.8,48.1,14.1,49.8,24.3,55.1,19.2,61.5,32.0,65.1,33.6,68.9,35.7,73.0,37.0,70.9,42.8,69.0,45.3,67.5,42.0,65.4,41.0,64.2,44.8,61.9,48.8,61.3,44.6,59.9,38.7,58.1,36.4,54.3,43.0,57.2,47.9,48.5,47.7,43.9,50.8,41.5,51.7,40.6,54.6,45.1,56.6,47.3,60.8,47.3,63.3,51.6,56.3,56.6,58.8,65.9,61.1,66.8,63.2,58.5,63.4,51.7,69.4,53.0,77.2,60.0,80.2,58.9,83.5,59.7,86.4,57.8,88.6,53.3,82.9,48.5,85.2,47.4,82.3,47.6,80.1,44.8,73.4,38.3,62.2,37.0,58.8,34.0,75.2,29.5,70.4,26.9,71.1,24.3,75.1,21.8,76.1
step
    +恭喜您达到375草本！
]])
...
step
    ...
    .技巧 herbalism,70 >> 在埃尔文森林从1-70开始升级你的草药。按“M”打开地图以查看路线。
...
step
    ...
    .技巧 herbalism,150,1
step
    .技巧 herbalism,150 >> 在Redridge Mountains，从70-150开始升级草药
...
step
    #completewith next
    .goto 地狱火半岛,53.6,65.8
    .zone 地狱火半岛 >> 飞向荣誉在地狱火半岛的飞行坐骑上举行
    .技巧 herbalism,325,1
    .技巧 riding,<300,1
step
    #label Rorelien
    .goto 地狱火半岛,54.2,65.4,15,0
    .goto 地狱火半岛,53.6,65.8
    .train 28695 >> 在荣誉馆内培训Rorelein的草药大师(300-375)
    .技巧 herbalism,325,1
step
    .技巧 herbalism,325 >> 在地狱火半岛从300-325升级你的草药
    .loop 45,地狱火半岛,27.9,80.6,31.1,61.8,43.5,63.9,43.0,72.9,38.1,87.2,45.7,85.5,49.8,69.2,62.0,68.9,67.4,77.9,65.4,58.4,72.3,62.3,80.3,79.6,73.8,59.2,66.8,55.5,67.1,52.2,71.9,51.9,73.9,40.2,66.8,43.7,65.7,28.1,59.0,35.9,55.6,28.9,51.0,23.9,49.2,36.5,45.1,41.9,49.0,47.1,59.8,47.1,61.0,53.7,52.5,54.6,48.6,58.9,42.9,56.0,37.7,42.6,41.0,30.8,35.5,29.3,27.5,36.8,31.4,48.6,24.1,44.4,20.5,40.1,18.2,46.1,14.6,36.8,12.1,55.2,13.8,61.8,17.2,53.6,22.7,54.9,22.9,65.9,27.9,80.6
step << Mage
    #completewith next
    .zone Shattrath City >> 传送到沙塔斯市
    .技巧 herbalism,350,1
