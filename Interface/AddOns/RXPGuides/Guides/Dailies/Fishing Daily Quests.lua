...
step << Alliance
	#completewith next
	>>记得买些小玩意儿用在你的鱼竿上
	.fly Valiance Landing Camp >>与Aludane交谈，飞往冬抓——autofly不在达拉到勇士登陆营地工作(wg)
	.goto Dalaran,72.18,45.78,20,0
	.isOnQuest 13834
step << Horde
	#completewith next
	>>记得买些小玩意儿用在你的鱼竿上
	.fly Warsong Camp, 冬抓>>与Aludane交谈，飞往冬抓——autofly不在达拉到战歌营地工作(wg)
	.goto Dalaran,72.18,45.78,20,0
	.isOnQuest 13834
step
	.goto 冬抓,79.57,46.92,-1
	.goto 冬抓,79.88,41.38,-1
	.zone 冬抓 >> 前往冬抓
	.isOnQuest 13834
step << Alliance
	>>在冬抓岛的任何地方捕鱼以防恐怖
	.goto 冬抓,71.05,36.85,-1
	.goto 冬抓,79.57,46.92,-1
	.goto 冬抓,79.88,41.38,-1
...
step << Alliance
	#completewith next
	>>记得买些小玩意儿用在你的鱼竿上
	.fly Une'pe >>与Aludane交谈，飞往Une’pe，Borean苔原
	.goto Dalaran,72.18,45.78,20,0
	.isOnQuest 13833
step << Horde
	#completewith next
	>>记得买些小玩意儿用在你的鱼竿上
	.fly Taunka'le >>与Aludane交谈，飞往Borean苔原的Taunka'le
	.goto Dalaran,72.18,45.78,20,0
	.isOnQuest 13833
step
	.goto BoreanTundra,75.56,42.01
	.zone BoreanTundra >>前往Borean苔原
	.isOnQuest 13833
