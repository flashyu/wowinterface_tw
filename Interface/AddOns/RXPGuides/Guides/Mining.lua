...
step
    #requires Pick
    .openmap Durotar
    .技巧 mining,65 >> 在Durotar从1-65开始平整你的采矿。按“M”打开地图以查看路线。
...
step
    .goto Orgrimmar,73.1,26.1
    .train 2576 >> Orgrimmar大楼内Makaru的Train Journeyman 采矿(75-150)
    .技巧 mining,125,1
step
    #completewith next
...
step
    .技巧 mining,125 >> 在荒地从65-125整平你的采矿[路线1]
...
step << !Mage
    ...
    .fly Orgrimmar
    .zone Orgrimmar >> 从Crossroads或Camp Taurajo飞往Orgrimmar，以较近的为准(最好是Crossroad)
    .技巧 mining,175,1
    .cooldown item,6948,<0,1
step << !Mage
    #completewith next
...
step << !Mage
    #completewith next
    .goto Durotar,45.5,12.2
    .zone Durotar >> 离开Orgrimmar进入Durotar。或者，支付法师一个通往幽暗城的门户
    .技巧 mining,175,1
    .zoneskip Undercity
step << !Mage
    .goto Durotar,50.7,13.3,20,0
    .goto Durotar,50.8,13.9
    .zone Stranglethorn Vale >> 爬上齐柏林塔。带着齐柏林飞艇去提里斯福尔冰川
    .技巧 mining,175,1
    .zoneskip Undercity
step << !Mage
    .goto Undercity,66.3,4.4
    .zone Undercity >> 跑进地下城，然后乘电梯下去
    .技巧 mining,175,1
...
step
    ...
    .zoneskip Arathi Highlands
step
    .技巧 mining,175 >> 在阿拉希高地从125-175整平你的采矿
...
step
    ...
    .技巧 mining,225,1
step
    .技巧 mining,225 >> 在腹地175-225整平你的采矿
...
step << Mage
    #completewith next
    .zone Tanaris >> 在世界尽头酒馆与西风交谈，传送到时间之穴。到达时不要与时间管理员交谈
    .技巧 mining,245,1
    .skipgossip
    .reputation 989,revered,<0,1
step
...
step
    >>如果矿脉内有矿脉，请进入硅石蜂巢
    .技巧 mining,245 >> 从塔纳瑞斯的225-245水平开采
...
step
    ...
    .技巧 mining,65 >> 在Elwynn Forest从1-65开始平整采矿。按“M”打开地图以查看路线。
...
step
    .技巧 mining,125 >> 在雷德里奇山脉从65-125整平您的采矿
