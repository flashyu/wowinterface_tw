...
step << Warlock wotlk
    ...
    +|cFFFCDC00Grind | cFFFF5722Mana Wyrms |右。将它们偷走，直到你拥有价值75铜的供应商物品。你也可以以13铜的价格出售你的装备 << Warlock wotlk
    .money >0.0075
...
step
    ...
    .accept 8328 >>接任务: |cFFFCDC00法师训练|r << Mage
    .accept 8563 >>接任务: |cFFFCDC00术士训练|r << Warlock
    .accept 8564 >>接任务: |cFFFCDC00牧师训练|r << Priest
    .accept 9392 >>接任务: |cFFFCDC00潜行者训练|r << Rogue
	.accept 9393 >>接任务: |cFFFCDC00猎人训练|r << Hunter
    .accept 9676 >>接任务: |cFFFCDC00圣骑士训练|r << Paladin
    .target Magistrix Erona
step
    #completewith next
...
step
    ...
    .turnin 10068 >>交任务: |cFF00FF25护井者索兰尼亚|r << Mage
    .turnin 10069 >>交任务: |cFF00FF25护井者索兰尼亚|r << Paladin
    .turnin 10070 >>交任务: |cFF00FF25护井者索兰尼亚|r << Hunter
    .turnin 10071 >>交任务: |cFF00FF25护井者索兰尼亚|r << Rogue
    .turnin 10072 >>交任务: |cFF00FF25护井者索兰尼亚|r << Priest
    .turnin 10073 >>交任务: |cFF00FF25护井者索兰尼亚|r << Warlock
...
step
    ...
    >>在顶部击杀|cFFFF5722被放逐者费伦德伦。抢他的|cFF00BCD4头|r
...
step
    ...
    .goto Eversong Woods,38.76,19.36
    .turnin 8338 >>交任务: |cFF00FF25被污染的奥术薄片|r << !Warlock tbc
...
step << Priest
    ...
    .accept 9489 >>接任务: |cFFFCDC00清理死亡之痕|r << BloodElf
    .train 591 >>训练你的职业技能
    .target Ponaris
step << Mage
...
step
    ...
    >>杀死一名|cFFFF5722Darnassian Scout |r。抢走他的|T133464:0|t[|cFF00BCD4指控文件|r]
...
step << Warrior/Warlock/Hunter/Rogue
    ...
    .gossipoption 91301 >>与|cFF00FF25Anvilward|r交谈
...
step << Warrior/Warlock/Hunter/Rogue
    ...
    >>|cFFFCDC00等待RP|r
    >>杀死|cFFFF5722浏览者Anvilward |r。抢他的|cFF00BCD4头|r
...
--VV     .accept 9395 >>接任务: |cFFFCDC00萨瑟利尔庄园|r << !BloodElf/!Hunter
step
    #xprate >1.4999
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Velan|r and |cFF00FF25Landra|r
    .accept 8491 >>接任务: |cFFFCDC00收集豹皮|r
...
step
    ...
    >>在顶部击杀鲁莽者|cFFFF5722Aldaron。抢夺他|cFF00BCD4Aldaron的头|r
...
step
    ...
    >>杀死|cFFFF5722Mmmrrgggll|r。为Mmrrrgggll|r的|cFF00BCD4Ring|r抢劫他
    >>|cFFFCDC00他在附近巡逻
...
step << skip
    ...
    >>|cFFFCDC00小心施法|r|T132282:0|t[打击]，|cFFFCDC0立即造成双倍伤害|r
...
step << skip
    ...
    .use 8474 >>杀死|cFFFF5722老白皮|r。抢了他|T133280:0|t[|cFF00BCD4Old Whitebark的吊坠|r]|cFFFCDC00使用它开始任务|r
...
step
    ...
    .goto Eversong Woods,54.28,70.97
    >>杀死|cFFFF5722Gharsul the Remarsless |r和|cFFFF5 722Angershades|r以保护|cFF00FF25Mirveda|r
...
step << Priest
    .goto Eversong Woods,47.85,47.97
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Ponaris|r upstairs
    .turnin 9489 >>接任务: |cFFFCDC00清理死亡之痕|r << BloodElf
    .train 8092 >>训练你的职业技能
    .target Ponaris
	.xp <10,1
    .xp >12,1
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Antheol|r
    .turnin 9066 >>交任务: |cFF00FF25导师的训诫|r
    .accept 9402 >>接任务: |cFFFCDC00捞瓶子|r << Mage
step
    #xprate >1.4999
    #label Antheol2
    .goto Eversong Woods,55.70,54.51
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Antheol|r
    .turnin 9064 >>交任务: |cFF00FF25学徒的欺瞒|r << !Undead !BloodElf/!Priest !Undead
    .turnin 9066 >>交任务: |cFF00FF25导师的训诫|r << BloodElf Priest/Undead
    .accept 9402 >>接任务: |cFFFCDC00捞瓶子|r << Mage
    .target Instructor Antheol
step << Mage
...
step
    ...
    .turnin 9359 >>交任务: |cFF00FF25远行者居所|r << !Tauren !Troll !Orc
    .accept 8476 >>接任务: |cFFFCDC00阿曼尼的进犯|r
    .accept 9484 >>接任务: |cFFFCDC00驯服野兽|r << BloodElf Hunter
...
step
    ...
    >>杀死|cFFFF5722枪匠奥滕贝|r。抢了他的|cFF00BCD4Hammer|r
    >>|cFFFF5722矛匠奥滕贝|r|cFFFCDC00有100%几率掉落白色或绿色物品|r << Paladin/Rogue/Warrior
...
step
    ...
    >>杀死|cFFFF5722酋长Zul'Marosh|r。因为他的|cFF00BCD4Head|r和|T134946:0|t[|cFF0BCD4Amani入侵计划|r]
    >>|cFFFCDC00使用|T134946:0|t[|cFF00BCD4Amani入侵计划|r]开始任务|r
    >>|cFFFF5722 Zul'Marosh酋长|r|cFFFCDC00有100%几率掉落白色或绿色物品|r << Paladin/Rogue/Warrior
...
step
    .goto Eversong Woods,62.51,79.68
    >>杀死|cFFFF5722酋长Zul'Marosh|r。抢了他的|cFF00BCD4Head|r和|T134946:0|t[|cFF0BCD4Mani入侵计划|r]
    >>|cFFFCDC00使用|T134946:0|t[|cFF00BCD4Amani入侵计划|r]开始任务|r
    .complete 8479,1 --Collect Chieftain Zul'Marosh's Head (x1)
    .collect 23249,1,9360,1 --Collect Amani Invasion Plans (x1)
    .accept 9360 >>接任务: |cFFFCDC00阿曼尼的入侵|r
...
step
    .goto Eversong Woods,70.53,72.33
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Ven'jashi|r in the Cage
    >>|cFFFCDC00如果你愿意，杀死|cFFFF5722枪匠奥滕贝|r。他有100%的机会丢弃白色或绿色物品|r << Paladin/Rogue/Warrior
...
step << skip
    .goto Eversong Woods,48.2,46.0
.target Aeldon Sunbrand
>>与|cFF00FF25Aeldon Sunbrand|r交谈
    .turnin 8483 >>交任务: |cFF00FF25矮人间谍|r
step << skip
    .goto Eversong Woods,55.700,54.509
.target Instructor Antheol
>>与|cFF00FF25讲师Anthol|r交谈
    .turnin 9066 >>交任务: |cFF00FF25导师的训诫|r
step << Undead/BloodElf
    #completewith next
    >>杀死|cFFFF5722 Springpaw Stalkers|r。抢夺他们的|cFF00BCD4Pelt|r
...
step
    ...
    .turnin 9485 >>交任务: |cFF00FF25驯服野兽|r << BloodElf Hunter
    .accept 9673 >>接任务: |cFFFCDC00野兽训练|r << BloodElf Hunter
    .target Lieutenant Dawnrunner
step << Undead/BloodElf
...
step << Mage
    ...
    >>杀死|cFFFF5722Eversong Green Keepers|r。抢夺他们的|cFF00BCD4生存分支|r
...
step
    ...
    .accept 9327 >>接任务: |cFFFCDC00被遗忘者|r << BloodElf
    .accept 9329 >>接任务: |cFFFCDC00被遗忘者|r << !BloodElf
...
step << !BloodElf/!Warlock
    ...
    .turnin 9327 >>交任务: |cFF00FF25被遗忘者|r << BloodElf
    .turnin 9329 >>交任务: |cFF00FF25被遗忘者|r << !BloodElf
    .accept 9758 >>接任务: |cFFFCDC00返回奥术师范迪瑞尔身边|r
    .goto Ghostlands,44.77,32.44
    .accept 9130 >>接任务: |cFFFCDC00银月城的货物|r << BloodElf
...
step << BloodElf
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Sunwing|r
    .turnin 9130 >>交任务: |cFF00FF25银月城的货物|r
    .accept 9133 >>接任务: |cFFFCDC00飞往银月城|r << Warlock/Priest
    .target Skymaster Sunwing
step << BloodElf
    #xprate >1.4999
    .goto Ghostlands,45.42,30.52
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Sunwing|r
    .turnin 9130 >>交任务: |cFF00FF25银月城的货物|r
    .accept 9133 >>接任务: |cFFFCDC00飞往银月城|r << Priest
    .target Skymaster Sunwing
step << BloodElf Warlock
    #completewith RuneOS
    .goto Ghostlands,45.42,30.52
...
step << Paladin
    ...
    .cast 3365 >>单击|cFFDB2EEFGildedBrazier|r召唤|cFFFF5722Sangrias Stillblade|r
step << Paladin
    #label FirstT
    .goto Ghostlands,68.50,9.77
    >>杀死|cFFFF5722Sangrias Stillblade |r
...
step
    ...
    .accept 9156 >>接任务: |cFFFCDC00通缉：纳克雷洛特和卢兹兰|r << !BloodElf/!Warlock
...
step << Paladin
    ...
    .accept 9684 >>接任务: |cFFFCDC00驾驭圣光|r << wotlk
    .accept 63866 >>接任务: |cFFFCDC00驾驭圣光|r << tbc
...
step << Paladin
    ...
    .goto Silvermoon City,89.26,35.20
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Bloodvalor|r
    .turnin 9684 >>交任务: |cFF00FF25驾驭圣光|r << wotlk
    .turnin 63866 >>交任务: |cFF00FF25驾驭圣光|r << tbc
...
step << Rogue
    .goto Silvermoon City,79.70,52.16
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Zelanis|r
    .turnin 9618 >>交任务: |cFF00FF25交回报告|r << BloodElf
    .accept 10372 >>接任务: |cFFFCDC00谨慎的询问|r
    .train 6761 >>训练你的职业技能
    .target Zelanis
    .train 6761,1
...
step
    ...
    .accept 9177 >>接任务: |cFFFCDC00幽暗城之旅|r << !BloodElf
    .accept 9180 >>接任务: |cFFFCDC00幽暗城之旅|r << BloodElf
    .goto Ghostlands,44.77,32.44
    .target Dame Auriferous
    .target High Executor Mavren
step << Druid
...
step
    ...
    >>杀死|cFFFF5722木乃伊猎头|r和|cFFFF5 722暗影神谕|r。为他们的|cFF00BCD4卷Juju|r
...
step
    #completewith TrollR
    >>杀死|cFFFF5722指定的猎头|r和|cFFFF5 722暗影神谕|r。为他们的|cFF00BCD4卷Juju|r
...
step << Rogue
    ...
    >>|T136058:0 |t[拾取锁]将|cFFDB2EEFBurial Chets|r放在地穴内的地面上。为|cFF00BCD4提交的金腰带|r
    >>单击地面上的|cFFDB2EEFMummized Troll Remains|r将其焚烧
...
step
    ...
    >>|cFFFCDC00A|cFFFF5722暗影神兵|r和一名|cFFFF5 722木乃伊猎头|r将在离开地下墓穴约60码后在|cFF00FF25Lilatha|r上产卵|r
...
step << Rogue
    #completewith next
    >>|T136058:0 | t[拾取锁]废墟附近地面上的|cFFDB2EEFPrimitive Chets|r。为考古专家的瘪头|cFF00BCD4抢来
...
step
    ...
    >>杀死|cFFFF5722暗影之星|r和|cFFFF5 722暗影猎人|r。抢夺他们的|cFF00BCD4ShadowcasterMaces|r和|cFF0BCD4HeadhunterAxes|r
...
step << Rogue
    ...
    >>|T136058:0|t[拾取锁定]地面上的|cFFDB2EEFPrimitive Chets|r。为考古专家的瘪头|cFF00BCD4抢来
    .complete 10548,1 --Archaeologist's Shrunken Head (1)
step
    #completewith KelGash
    ...
    >>杀死|cFFFF5722暗影之刃猫王|r和|cFFFF5 722暗影六角蛇|r。抢夺他们的|cFF00BCD4Catlord爪|r和|cFF0BCD4Exxer杆|r
...
step
    ...
    >>杀死|cFFFF5722Kel'gash the Wicked|r。抢他的|cFF00BCD4头|r
    >>道奇|cFFFF5722Kel'gash the Wicked|r的|T136048:0|t[闪电]和|T136121:0|t[收缩]由LoSing（视线）围绕柱子，因此他取消了每个法术
...
step
    ...
    .goto Ghostlands,65.29,79.46
    >>杀死|cFFFF5722Kel'gash the Wicked|r。抢他的|cFF00BCD4头|r
    >>道奇|cFFFF5722Kel'gash the Wicked|r的|T136048:0|t[闪电]和|T136121:0|t[收缩]由LoSing（视线）围绕柱子，因此他取消了每个法术。确保您有可用的冷却系统
    >>|cFFFCDC00如果需要，为他找组|r << !Hunter !Warlock
    .complete 9215,1 --Collect Head of Kel'gash the Wicked (x1)
    .mob Kel'gash the Wicked
    .use 858
...
step
    ...
    >>如果他在|cFF00FF25Varnis|r旁边，杀死|cFFFF5722血书|r
...
step
    ...
    >>检查|cFFFF5722Masophet第一个Ziggurat内部的黑色|r。如果他起来就杀了他
...
step
 ...
 step
    #completewith next
    >>如果他在|cFF00FF25Vedoran|r旁边，杀死|cFFFF5722血书|r
    .complete 9170,2 --Kill Borgoth the Bloodletter (x1)
    .mob Borgoth the Bloodletter
step
    #label Vedoran
...
step
    ...
    >>在任何一个变形怪内部杀死|cFFFF5722Masophet the Black|r
    .complete 9170,4 --Kill Masophet the Black (x1)
    .mob Masophet the Black
step
    .goto Ghostlands,32.84,88.21,10,0
...
step
    ...
    >>杀死|cFFFF5722Dar'Khan Drathir|r在Ziggurat底部
...
step
    ...
    .accept 9328 >>接任务: |cFFFCDC00辛多雷的英雄|r << BloodElf
    .accept 9811 >>接任务: |cFFFCDC00辛多雷的朋友|r << !BloodElf
    .target Magister Kaendris
...
step
    ...
    .turnin 9328 >>交任务: |cFF00FF25辛多雷的英雄|r << BloodElf
    .accept 9621 >>接任务: |cFFFCDC00部落的特使|r << BloodElf
    .turnin 9811 >>交任务: |cFF00FF25辛多雷的朋友|r << !BloodElf
    .accept 9812 >>接任务: |cFFFCDC00部落的特使|r << !BloodElf
...
step
    ...
    .turnin 9621 >>交任务: |cFF00FF25部落的特使|r << BloodElf
    .accept 9626 >>接任务: |cFFFCDC00觐见酋长|r << BloodElf
    .turnin 9180 >>交任务: |cFF00FF25幽暗城之旅|r << BloodElf
    .turnin 9812 >>交任务: |cFF00FF25部落的特使|r << !BloodElf
    .accept 9813 >>接任务: |cFFFCDC00觐见酋长|r << !BloodElf
    .turnin 9177 >>交任务: |cFF00FF25幽暗城之旅|r << !BloodElf
    .goto Undercity,58.06,91.79
    .accept 9425 >>接任务: |cFFFCDC00前往塔伦米尔|r << BloodElf
