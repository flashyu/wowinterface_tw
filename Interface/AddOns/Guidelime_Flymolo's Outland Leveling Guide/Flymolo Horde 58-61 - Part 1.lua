...
[G65.1,51.2 Hellfire Peninsula]*Note:* During the next steps, avoid going deep into the canyon as the mobs there are elite.
...
*Note:* For the next quest, you will need to get torches off the peons. Once the torch is lit, you may find more and can carry multiple lit torches. However, *each torch only stays lit for a FEW MINUTES so you need to use them at their destinations quickly!!* You may need to make multiple trips back to the forge.
