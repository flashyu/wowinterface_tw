...
function NS.CoreUI.BuildBars()
  ...
  for k = 1, NS.Options.Bars.MaxNumBars do
    ...
    NS.CoreUI.Bar[k].Level:SetFont(SM:Fetch("font", NS.Options.Bars.LevelFont), NS.Options.Bars.LevelFontSize, "OUTLINE")
    ...
    NS.CoreUI.Bar[k].Guild:SetFont(SM:Fetch("font", NS.Options.Bars.GuildFont), NS.Options.Bars.GuildFontSize, "OUTLINE")
