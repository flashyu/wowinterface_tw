...
local function TalentFrame_ADD()
	...
	hooksecurefunc("PlayerTalentFrame_ShowGlyphFrame", function()
		if not GlyphFrame.big then
			...
			for i=1,6 do
				...
				GlyphBUT.name = PIGFontString(GlyphBUT,nil,nil,nil,23.4)
			...
			GlyphFrame.big = PIGFontString(GlyphFrame,{"TOPLEFT",GlyphFrame,"TOPLEFT",10,-10},"大雕文")
			...
			GlyphFrame.mini = PIGFontString(GlyphFrame,{"TOPLEFT",GlyphFrameGlyph6,"BOTTOMLEFT",0,-40},"小雕文")
	...
	PlayerTalentFrame.shengyu = PIGFontString(PlayerTalentFrame,{"TOP",PlayerTalentFrame,"TOP",-80,-44},"剩余天赋点数")
	...
	for i=1,3 do
		...
		fujik.Tianfu = PIGFontString(fujik,{"BOTTOM",fujik,"BOTTOM",-20,6})
	...
	---
	PlayerTalentFrame.yulanTF=PIGCheckbutton(PlayerTalentFrame,{"TOPLEFT",PlayerTalentFrame,"TOPLEFT",72,-14},{"模拟模式","点击天赋时可先模拟，确定后再学习模拟结果"})
