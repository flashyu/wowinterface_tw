...
local function ADD_QuickBut_Keyword()
	...
	--选项
	local XXX,YYY = 26,28
	guanjianzi.F.shezhi.F.fanyejian = ADD_Checkbutton(nil,guanjianzi.F.shezhi.F,-100,"TOPLEFT",guanjianzi.F.shezhi.F,"TOPLEFT",10,-100,"菜单显示在右侧","菜单显示在右侧")
	...
	guanjianzi.F.shezhi.F.guolvzishen = ADD_Checkbutton(nil,guanjianzi.F.shezhi.F,-100,"TOPLEFT",guanjianzi.F.shezhi.F,"TOPLEFT",10,-130,"不显示自身发言","不显示自身发言")
	...
	--
	guanjianzi.F.shezhi.F.xitongjihuoB = ADD_Checkbutton(nil,guanjianzi.F.shezhi.F,-100,"TOPLEFT",guanjianzi.F.shezhi.F,"TOPLEFT",10,-160,"启用系统聊天黑名单","开起后黑名单也会对系统聊天栏生效，否则只对提取聊天栏生效")
	...
	--
	guanjianzi.F.shezhi.F.guolvchongfu = ADD_Checkbutton(nil,guanjianzi.F.shezhi.F,-100,"TOPLEFT",guanjianzi.F.shezhi.F,"TOPLEFT",10,-190,"过滤重复发言","过滤1分钟之内的重复发言(此功能也会对系统聊天栏生效)")
