...
if tocversion<70000 then
	...
	CombatPlusF.SetF.SliderX:SetScript("OnValueChanged", function(self)
		...
		if HPMPBar_UI then
			HPMPBar_UI:SetPoint("CENTER", UIParent, "CENTER", Value, PIGA["CombatPlus"]["HPMPBar"]["Ypianyi"]);
		end
	end)
	...
	CombatPlusF.SetF.SliderY:SetScript("OnValueChanged", function(self)
		...
		if HPMPBar_UI then
			HPMPBar_UI:SetPoint("CENTER", UIParent, "CENTER", PIGA["CombatPlus"]["HPMPBar"]["Xpianyi"], Value);
		end
	end)
	local function SetValueXY(self)
		self.SetF.SliderY:SetValue(PIGA["CombatPlus"]["HPMPBar"]["Ypianyi"]);
		self.SetF.SliderX:SetValue(PIGA["CombatPlus"]["HPMPBar"]["Xpianyi"]);
	end
	...
	CombatPlusF:HookScript("OnShow", function (self)
		...
		self.SetF.Slider:SetValue(PIGA["CombatPlus"]["HPMPBar"]["Scale"]);
		SetValueXY(self)
	end);
end