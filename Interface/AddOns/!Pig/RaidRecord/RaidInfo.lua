...
-------
function RaidRFun.RaidRecord_RaidInfo()
	...
	fujiF.tishi.t = PIGFontString(fujiF.tishi,{"LEFT", fujiF.tishi, "RIGHT", 0,0.6},"玩家名可点击,左键-\124cff00ff00设置补助类型\124r,右键-\124cff00ff00设置分G比例。\124r","OUTLINE");
	--职业图标================================
	--全部
	...
	function RaidR:GetRiadPlayerInfo()
		...
		PIGA["RaidRecord"]["Raidinfo"]=renyuanData;
	end
	--显示刷新
	...
	fujiF:HookScript("OnEvent",function(self, event,arg1,_,_,_,arg5)
		...
		if not PIGA["RaidRecord"]["Dongjie"] then
