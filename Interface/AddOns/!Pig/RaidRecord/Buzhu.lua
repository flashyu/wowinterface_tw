...
-------
function RaidRFun.RaidRecord_Buzhu()
	...
	fujiF.buzhu_QITA.Add.F.YES:SetScript("OnClick", function (self)
		...
		if  huoquV=="" or huoquV==" " then
			...
			for i=1,#PIGA["RaidRecord"]["jiangli"] do
				if huoquV==PIGA["RaidRecord"]["jiangli"][i][1] then
	...
	fujiF.buzhu_QITA.tishi:SetSize(iconWH,iconWH);
	fujiF.buzhu_QITA.tishi:SetPoint("TOPLEFT",fujiF.buzhu_QITA.yedibuF,"BOTTOMLEFT",6,-4);
	fujiF.buzhu_QITA.tishi.Tex = fujiF.buzhu_QITA.tishi:CreateTexture(nil, "BORDER");
	fujiF.buzhu_QITA.tishi.Tex:SetTexture("interface/common/help-i.blp");
	fujiF.buzhu_QITA.tishi.Tex:SetSize(iconWH+8,iconWH+8);
	fujiF.buzhu_QITA.tishi.Tex:SetPoint("CENTER");
	PIGEnter(fujiF.buzhu_QITA.tishi,"\124cff00ff00未设置奖励人的项目不会计入奖励支出\124r")
	...
	fujiF.buzhu_QITA.piliangBut = PIGButton(fujiF.buzhu_QITA,{"TOPRIGHT",fujiF.buzhu_QITA.yedibuF,"BOTTOMRIGHT",-10,-4},{72,22},"批量设置");
	fujiF.buzhu_QITA.piliangBut:SetScale(0.94)
	fujiF.buzhu_QITA.piliangBut:SetScript("OnClick", function (self)
		local BuzhuNewV = self.E:GetNumber();
		self.E:ClearFocus() 
		local dataX = PIGA["RaidRecord"]["jiangli"]
    	for p=1,#dataX do
	...
	fujiF.buzhu_QITA.piliangBut.E = CreateFrame("EditBox", nil, fujiF.buzhu_QITA.piliangBut, "InputBoxInstructionsTemplate");
	fujiF.buzhu_QITA.piliangBut.E:SetSize(60,20);
	fujiF.buzhu_QITA.piliangBut.E:SetPoint("RIGHT",fujiF.buzhu_QITA.piliangBut,"LEFT",-4,0);
	PIGSetFont(fujiF.buzhu_QITA.piliangBut.E,14,"OUTLINE")
	fujiF.buzhu_QITA.piliangBut.E:SetMaxLetters(6)
	fujiF.buzhu_QITA.piliangBut.E:SetAutoFocus(false)
	fujiF.buzhu_QITA.piliangBut.E:SetNumeric(true)
	fujiF.buzhu_QITA.piliangBut.E:SetTextColor(0.6, 0.6, 0.6, 0.8); 
	fujiF.buzhu_QITA.piliangBut.E:SetText(100);
	fujiF.buzhu_QITA.piliangBut.E:SetScript("OnEscapePressed", function(self)
		self:ClearFocus() 
	end);
	fujiF.buzhu_QITA.piliangBut.E:SetScript("OnEditFocusGained", function(self)
		self:SetTextColor(1, 1, 1, 1); 
	end)
	fujiF.buzhu_QITA.piliangBut.E:SetScript("OnEnterPressed", function(self) 
		self:ClearFocus() 
	end);
	fujiF.buzhu_QITA.piliangBut.E:SetScript("OnEditFocusLost", function(self) 
		self:SetTextColor(0.5, 0.5, 0.5, 0.8);
	end)
end