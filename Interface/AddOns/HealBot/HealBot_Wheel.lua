...
function HealBot_MountsPets_InitMount()
    ...
    if #HealBot_GMount==0 and #HealBot_FMount==0 then
        ...
        if #HealBot_GMount>0 then
            HealBot_Config.FavGroundMount=HealBot_Config.FavGroundMount or HealBot_GMount[1]
        else
            HealBot_Config.FavGroundMount=""
        end
        if #HealBot_FMount>0 then
            HealBot_Config.FavMount=HealBot_Config.FavMount or HealBot_FMount[1]
        else
            HealBot_Config.FavMount=""
        end
    end
