	...
	["profiles"] = {
		["Default"] = {
			...
			["saved_cvars_last_change"] = {
				["nameplateMinAlpha"] = "[string \"=[C]\"]: in function `SetCVar'\n[string \"@Interface/AddOns/Plater/Plater.lua\"]:2311: in function <Interface/AddOns/Plater/Plater.lua:2292>\n",
...
PlaterLogs = {
	["_general_logs"] = {
		"2023-06-22 17:54:25 | INIT | Plater-v560.4-Wrath | Framework v434 | 3.4.2 | zhCN | 邁克爾假死", -- [1]
		"2023-06-22 17:47:44 | INIT | Plater-v560.4-Wrath | Framework v434 | 3.4.2 | zhCN | 特變電工", -- [2]
	},
	["_error_logs"] = {
	},
}
